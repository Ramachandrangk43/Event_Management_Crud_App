...
import { eventApi, categoryApi, Event, Category, isInDemoMode } from '../lib/api'
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                <strong>Demo Mode:</strong> You're viewing sample data. All features work normally, but changes won't be saved. 
                To connect a real backend, deploy the Django API and set the <code className="bg-blue-100 px-1 rounded">NEXT_PUBLIC_API_URL</code> environment variable.
              </p>
            </div>
          </div>
        </div>
